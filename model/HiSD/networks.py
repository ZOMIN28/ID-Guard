...
class Gen(nn.Module):
    ...
    def forward(self, img, r, type_num):
        c = self.encode(img)
        c_trg = c
        s_trg = self.extract(r, type_num)
        c_trg = self.translate(c_trg, s_trg, type_num)
        return self.decode(c_trg)
